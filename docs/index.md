...
- :lucide-git-pull-request-arrow: [Pre-commit] Hooks, run with [Prek]
- :lucide-logs: autogenerated Changelog with [Git Changelog] or [Git Cliff]
- :lucide-music: Task orchestration with [Justfile][Just]
- :lucide-scale: Preconfigured Licenses to choose from
- :lucide-scroll-text: Documentation from [Zensical]
...
- `just dev` to create a virtual environment and install the pre-commit hooks
