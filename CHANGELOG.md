...
- *(template)* add cover recipe to inspect coverage in a browser

### 🐛 Bug Fixes

- release even when no dependencie gets updates
...
- *(template)* slim down on the just recipes
- slim down justfile
- *(template)* use lowercase justfile
- rename justfile
- *(template)* update template dependencies
...
- *(template)* dynamic copyright date in zensical docs
- *(template)* add pre-comit autoupdate to update recipe

### 🚜 Refactor

- *(script)* make async http requests
...
- *(template)* add py.typed marker file by default

### 🚜 Refactor

- clean up update script
- move dependcy update rules into separate json file

### 🧪 Testing

- add py.typed to expected files

### 💼 Other

- add pydantic to script dependecies
- add template update to the release pipeline
- *(template)* update template dependencies
...
[0.3.0]: https://github.com/npikall/py-bootstrap/compare/v0.2.9..v0.3.0
[0.2.9]: https://github.com/npikall/py-bootstrap/compare/v0.2.8..v0.2.9
[0.2.8]: https://github.com/npikall/py-bootstrap/compare/v0.2.7..v0.2.8
[0.2.7]: https://github.com/npikall/py-bootstrap/compare/v0.2.6..v0.2.7
