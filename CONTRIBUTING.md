...
Report bugs at [`github.com/npikall/py-bootstrap`][repo].
...
`py-bootstrap` could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at [`github.com/npikall/py-bootstrap`][repo].
...
Ready to contribute? Here's how to set up `py-bootstrap` for local development.

1. Fork the `py-bootstrap` repo on GitHub.
2. Clone your fork locally:
   ```sh
   git clone git@github.com:npikall/py-bootstrap.git
   ```
...
5. Create a virtualenv. Assuming you have [uv] and [Just] installed, this is how you set up your fork for local development:
   ```sh
...
7. When you're done making changes, check that your changes are formatted correctly and the tests, including testing other Python versions.
   ```sh
...
[repo]: https://github.com/npikall/py-bootstrap/issues
