...
Report bugs at https://github.com/{{ cookiecutter.author }}/{{ cookiecutter.project_slug }}/issues.
...
The best way to send feedback is to file an issue at https://github.com/{{ cookiecutter.author }}/{{ cookiecutter.project_slug }}/issues.
